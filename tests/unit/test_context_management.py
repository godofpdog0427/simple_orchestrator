...
class TestObservationMasking:
    ...
    def test_old_tool_results_get_masked(self):
        ...
        with patch.object(orch, '_build_system_prompt', return_value="system"):
            result = orch._manage_context_window(history, _context())

        # First tool result (index 1) should be masked
    ...
    def test_small_tool_results_not_masked(self):
    ...
    def test_empty_history(self):
        ...
        orch = _make_orchestrator()
        with patch.object(orch, '_build_system_prompt', return_value="system"):
            result = orch._manage_context_window([], _context())
        assert result == []
...
class TestEmergencyDrop:
    ...
    def test_emergency_drop_when_over_budget(self):
...
class TestTokenTrackingFix:
    ...
    def test_usage_has_input_output_tokens(self):
        ...
        # Simulate what the Anthropic API returns
